...
export default function Page() {
  ...
  // Upload processing state, then Profile
  ...
  // Review: undo a decision (called from recommendation panel undo button)
  ...
  // Review: select issue from queue
  ...
  // Sidebar navigation (only accessible screens)
